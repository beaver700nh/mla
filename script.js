const SKELETON_TEMPLATE =
  `<div style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt;">` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0px; margin-bottom: 0px; text-align: left;">` +
      `%{{your-name}}` +
    `</p>` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0; margin-bottom: 0pt; text-align: left;">` +
      `%{{subj-name}}` +
    `</p>` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0; margin-bottom: 0pt; text-align: left;">` +
      `%{{teacher-name}}` +
    `</p>` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0; margin-bottom: 10pt; text-align: left;">` +
      `%{{the-date}}` +
    `</p>` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0; margin-bottom: 10pt; text-align: center;">` +
      `%{{the-title}}` +
    `</p>` +
    `<p style="font-family: &quot;Times New Roman&quot; serif; font-size: 12pt; line-height: 200%; margin-top: 0; margin-bottom: 0pt; text-align: left; text-indent: 36pt;">` +
...
const INPUTS = [
  ...
  {type: "the-date",     fallback: "1 January 2000"},
...
function copy_to_clipboard(html) {
  ...
  navigator.clipboard.write(data).then(
    function success() {
      $("#modal-title").html("Text has been copied to clipboard!<br />Now you can paste it into Google Docs!");
    },
    function failure(err) {
      $("#modal-title").html(`Couldn't copy to clipboard: ${err}<br /><br />Try copying manually instead.`);
    }
  );
}
